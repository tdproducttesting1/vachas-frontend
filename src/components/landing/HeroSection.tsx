        ...
        <div className="flex flex-col items-center space-y-12 text-center">
          <div className="space-y-6 md:w-4/5 lg:w-3/5 animate-fade-in">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight bg-gradient-to-r from-blue-600 to-violet-600 bg-clip-text text-transparent">
              Human-Like AI Voice Agents with Advanced Post-Call Analytics
            </h1>
            <p className="text-xl text-gray-600 md:w-4/5 mx-auto">
              Experience the future of outbound calling with AI agents that sound completely human and provide comprehensive analytics after every conversation. Our proprietary voice technology and deep analytics give you the competitive edge.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Button asChild size="lg" className="h-12 px-8 shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in hover-scale">
